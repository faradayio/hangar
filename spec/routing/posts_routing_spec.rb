...
describe 'Post routing' do
  ...
  it 'provides #update route' do
    expect(patch('/posts/1')).to route_to('posts#update', post_id: 1)
  end  
  it 'provides #new route' do
    expect(get('/posts/new')).to route_to('posts#new')
  end  
  it 'provides #show route' do
    expect(get('/posts/1')).to route_to('posts#show', post_id: 1)
  end  
  it 'provides #delete route' do
    expect(delete('/posts/1')).to route_to('posts#destroy', post_id: 1)
  end  
